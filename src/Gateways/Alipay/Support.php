...
use DYC\Pay\Exceptions\InvalidConfigException;
use DYC\Pay\Exceptions\InvalidSignException;
use DYC\Pay\Log;
use DYC\Supports\Arr;
use DYC\Supports\Collection;
use DYC\Supports\Str;
use DYC\Supports\Traits\HasHttpRequest;
...
class Support
{
	 ...
	 * @author mengyu.wh
	 */
	public static function alonersaSign($data,$privatekey,$signType = "RSA",$keyfromfile=false) {
