...
use DYC\Pay\Exceptions\InvalidArgumentException;
use DYC\Pay\Log;
use DYC\Supports\Collection;
use DYC\Supports\Config;

class AuthTokenGateway implements GatewayInterface
{
    /**
     * Config.
     *
    ...
    public function pay($endpoint, array $payload): Collection
    {
        ...
        return Support::requestOauth($payload, $this->config->get('ali_public_key'));
    }
