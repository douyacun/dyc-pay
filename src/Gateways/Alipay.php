...
use DYC\Pay\Gateways\Alipay\Support;
use DYC\Pay\Log;
...
/**
 * @method \DYC\Pay\Gateways\Alipay\AppGateway app(array $config) APP 支付
 * @method \DYC\Pay\Gateways\Alipay\PosGateway pos(array $config) 刷卡支付
 * @method \DYC\Pay\Gateways\Alipay\ScanGateway scan(array $config) 扫码支付
 * @method \DYC\Pay\Gateways\Alipay\TransferGateway transfer(array $config) 帐户转账
 * @method \DYC\Pay\Gateways\Alipay\WapGateway wap(array $config) 手机网站支付
 * @method \DYC\Pay\Gateways\Alipay\WebGateway web(array $config) 电脑支付
 * @method \DYC\Pay\Gateways\Alipay\AuthGateway auth(array $config) App授权生成签名
 * @method \DYC\Pay\Gateways\Alipay\AuthTokenGateway authToken(array $config) App授权生成签名
 * @method \DYC\Pay\Gateways\Alipay\UserInfoGateway userInfo(array $config) 获取会员信息
 */
