...
use DYC\Pay\Exceptions\InvalidGatewayException;
use DYC\Pay\Exceptions\InvalidSignException;
use DYC\Pay\Gateways\Wechat\Support;
use DYC\Pay\Log;
use DYC\Supports\Collection;
use DYC\Supports\Config;
use DYC\Supports\Str;

/**
 * @method \DYC\Pay\Gateways\Wechat\AppGateway app(array $config) APP 支付
 * @method \DYC\Pay\Gateways\Wechat\GroupRedpackGateway groupRedpack(array $config) 分裂红包
 * @method \DYC\Pay\Gateways\Wechat\MiniappGateway miniapp(array $config) 小程序支付
 * @method \DYC\Pay\Gateways\Wechat\MpGateway mp(array $config) 公众号支付
 * @method \DYC\Pay\Gateways\Wechat\PosGateway pos(array $config) 刷卡支付
 * @method \DYC\Pay\Gateways\Wechat\RedpackGateway redpack(array $config) 普通红包
 * @method \DYC\Pay\Gateways\Wechat\ScanGateway scan(array $config) 扫码支付
 * @method \DYC\Pay\Gateways\Wechat\TransferGateway transfer(array $config) 企业付款
 * @method \DYC\Pay\Gateways\Wechat\WapGateway wap(array $config) H5 支付
 * @method \DYC\Pay\Gateways\Wechat\AuthGateway auth(array $config) 微信授权
 */
